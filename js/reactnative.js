      ...
      state: {
        ...
        steps: [
          ...
          },
          {
                    "id": "state-11-final",
                    "menu": "11. Final",
                    "title": "11 — Código completo",
                    "objective": "Revisar o aplicativo completo da Média Escolar.",
                    "code": "import React, { useState } from 'react';\nimport { View, Text, TextInput, Button, StyleSheet } from 'react-native';\n\nexport default function App() {\n  const [nota1, setNota1] = useState('');\n  const [nota2, setNota2] = useState('');\n  const [media, setMedia] = useState('');\n  const [situacao, setSituacao] = useState('');\n\n  function calcularMedia() {\n    const resultado = (Number(nota1) + Number(nota2)) / 2;\n\n    setMedia(resultado);\n\n    if (resultado >= 6) {\n      setSituacao('Aprovado');\n    } else {\n      setSituacao('Reprovado');\n    }\n  }\n\n  function limpar() {\n    setNota1('');\n    setNota2('');\n    setMedia('');\n    setSituacao('');\n  }\n\n  return (\n    <View style={styles.container}>\n      <Text style={styles.titulo}>Média Escolar</Text>\n\n      <Text>Nota 1:</Text>\n      <TextInput\n        style={styles.campo}\n        value={nota1}\n        onChangeText={setNota1}\n        keyboardType=\"numeric\"\n      />\n\n      <Text>Nota 2:</Text>\n      <TextInput\n        style={styles.campo}\n        value={nota2}\n        onChangeText={setNota2}\n        keyboardType=\"numeric\"\n      />\n\n      <View style={styles.botoes}>\n        <View style={styles.botao}>\n          <Button title=\"Calcular\" onPress={calcularMedia} />\n        </View>\n\n        <View style={styles.botao}>\n          <Button title=\"Limpar\" onPress={limpar} />\n        </View>\n      </View>\n\n      <Text style={styles.resultado}>Média: {media}</Text>\n      <Text style={styles.resultado}>Situação: {situacao}</Text>\n    </View>\n  );\n}\n\nconst styles = StyleSheet.create({\n  container: {\n    flex: 1,\n    padding: 30,\n    marginTop: 50,\n  },\n  titulo: {\n    fontSize: 24,\n    fontWeight: 'bold',\n    marginBottom: 20,\n  },\n  campo: {\n    borderWidth: 1,\n    borderColor: '#999',\n    padding: 10,\n    marginVertical: 10,\n  },\n  botoes: {\n    flexDirection: 'row',\n    marginTop: 10,\n  },\n  botao: {\n    flex: 1,\n    marginHorizontal: 5,\n  },\n  resultado: {\n    fontSize: 18,\n    marginTop: 20,\n  },\n});",
          ...
          },
          {
                    ...
                    "exercisePage": true,
                    "html": "\n<div class=\"exercise-native exercise-clean\">\n  <div class=\"topline exercise-clean-top\">\n    <h2>99. Exercícios — A Inteligência do Aplicativo</h2>\n    <div class=\"objective\"><strong>Objetivo:</strong> praticar entrada de dados, cálculo, decisão e atualização da tela.</div>\n  </div>\n  <section class=\"exercise-clean-section active\">\n    <div class=\"exercise-grid\">\n      <div class=\"panel brief\"><div class=\"panel-title\">Exercícios</div><div class=\"panel-body\">\n        <h3>Pratique a mesma lógica</h3>\n        <ol>\n          <li><strong>Média de 3 notas:</strong> adicione Nota 3 e calcule a média de três valores.</li>\n          <li><strong>Conversor de temperatura:</strong> digite Celsius e mostre Fahrenheit.</li>\n          <li><strong>Calculadora de desconto:</strong> digite preço e desconto para mostrar o valor final.</li>\n          <li><strong>Situação com outra regra:</strong> altere a média mínima para 7.</li>\n          <li><strong>Limpar melhorado:</strong> verifique se todos os campos e resultados voltam para vazio.</li>\n        </ol>\n        <div class=\"tagline\"><strong>Ideia central:</strong> usuário digita → state guarda → botão chama função → app processa → tela atualiza.</div>\n      </div></div>\n      <div class=\"mockup-wrap\"><div class=\"phone\"><div class=\"appbar blue\">Média Escolar</div><div class=\"mock-body\"><div class=\"field-group b-blue\"><div class=\"label\">Nota 1</div><div class=\"input\"></div><div class=\"label\">Nota 2</div><div class=\"input\"></div><div class=\"label\">Nota 3</div><div class=\"input\"></div></div><div class=\"button-row b-green\"><div class=\"btn btn-blue\">Calcular</div><div class=\"btn btn-gray\">Limpar</div></div><div class=\"field-group b-orange\"><div class=\"label\">Resultado</div><div class=\"input\"></div></div></div></div></div>\n    </div>\n    <div class=\"obs\"><strong>Observação:</strong> os exercícios não precisam de APIs. O foco ainda é a inteligência interna do aplicativo.</div>\n  </section>\n</div>"
          }
]
      },
      apiCep: {
