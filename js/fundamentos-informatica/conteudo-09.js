  ...
  content: `
    ...
    <div class="media-text">
      <figure class="historical-media">
        ...
        <figcaption><strong>Tela de configuração do firmware de um PC moderno.</strong> Ela aparece antes de Windows, Linux ou outro sistema operacional ser carregado.<span class="credit">VulcanSphere / Insyde Software · Wikimedia Commons; consulte a licença na página do arquivo.</span></figcaption>
      </figure>
      <div>
    ...
    <div class="representation-flow" aria-label="Inicialização simplificada">
      ...
      <div><strong>Gerenciador / bootloader</strong><span>localiza e inicia o SO</span></div><span class="flow-arrow">→</span>
    ...
    <details class="sources-box"><summary>Fontes e crédito da imagem</summary><ul>
      ...
      <li><a href="https://commons.wikimedia.org/wiki/File:InsydeH2O_UEFI_security_screenshot.jpg" target="_blank" rel="noopener">Wikimedia Commons — tela de configuração</a></li>
    </ul></details>
  `
});
