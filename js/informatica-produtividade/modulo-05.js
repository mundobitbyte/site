window.produtividadeLessons = (window.produtividadeLessons || []).concat([
  {
    ...
    content: `
      ...
      <h3>Ferramenta principal</h3><div class="task-box"><strong>Simulador local MbB + pasta colaborativa institucional autorizada</strong><ol><li>Baixe o <a href="../downloads/informatica-produtividade/modulo-05/caixa-comunicacao-feira.zip" download>pacote de comunicações fictícias</a> e extraia em uma cópia de trabalho.</li><li>Abra <code>LEIA-ME.txt</code> e depois os itens na ordem de data indicada. Não envie nada para pessoas reais.</li><li>Em P-40, registre para cada item: canal, remetente, assunto, decisão, tarefa, responsável, prazo, arquivo/link e pendência.</li><li>Compare anexos com P-03. “Mais recente” não substitui “aprovado”.</li><li>Se usar uma plataforma institucional real na aula, trabalhe apenas no espaço fornecido pelo professor e com dados fictícios.</li></ol></div>
      <div class="evidence-box"><strong>Resultado esperado</strong><p>Você encontra decisão sem versão identificada, reunião sem convidados, tarefa sem responsável e link com permissão excessiva. Registre sintomas; as causas serão testadas ao longo do módulo.</p></div>
      <div class="artifact-card"><strong>P-40 iniciado</strong><span>Necessidade, canal, mensagem/decisão, destinatários, arquivo/link, permissão, responsável, prazo, status, evidência e encerramento.</span></div>
  ...
  },
  {
    ...
    content: `
      ...
      <h3>Aplicar em P-40</h3><div class="task-box"><ol><li>Liste as quatro necessidades encontradas no diagnóstico.</li><li>Para cada uma, marque urgência, público, sensibilidade, necessidade de resposta e duração do registro.</li><li>Escolha um canal principal e escreva onde a decisão final será registrada.</li><li>Defina o que não deve ir naquele canal: senha, dado pessoal, versão de trabalho ou lista pública de endereços.</li><li>Peça a um colega que tente localizar “qual versão foi aprovada?” usando somente o mapa. Se não conseguir, ajuste o registro final.</li></ol></div>
...
Marina</textarea><div><button class="action-button" type="button" data-copy="#modelo-email">Copiar modelo</button><span class="copy-status" aria-live="polite"></span></div></div>
  ...
  },
  {
    ...
    content: `
      ...
      <h3>Simular a criação</h3><div class="task-box"><ol><li>No modelo de agenda fornecido pelo professor, escolha <strong>Novo evento</strong>.</li><li>Título: “Decidir programação e liberar impressão”. Evite “Reunião Feira”.</li><li>Adicione Paulo, Marina e Lia; confira disponibilidade antes de confirmar 13h30–13h50.</li><li>Na descrição, inclua objetivo, três itens de pauta, link com permissão testada e decisão esperada.</li><li>Defina lembrete compatível com a preparação e indique local/equipamento.</li><li>Salve e confirme que cada convidado aparece no evento. Se mudar o horário, edite o mesmo evento e envie atualização; não crie duplicata.</li><li>Registre ID/título, horário, convidados e material em P-40.</li></ol></div>
  ...
  },
  {
    ...
    content: `
      ...
      <h3>Registrar</h3><div class="task-box"><ol><li>Divida o resultado em tarefas independentes que começam com verbo.</li><li>Atribua um responsável principal por tarefa. Colaboradores podem apoiar, mas o acompanhamento precisa de um dono.</li><li>Defina data e hora quando o prazo afeta outra tarefa; registre dependências.</li><li>Defina critério observável: arquivo aprovado, prova conferida, projetor testado.</li><li>Use estados consistentes: <strong>A fazer</strong>, <strong>Em andamento</strong>, <strong>Bloqueada</strong>, <strong>Concluída</strong>.</li><li>Se bloquear, registre causa conhecida, evidência e quem decide o próximo passo. Não marque concluída por esforço.</li><li>Atualize P-40 e teste se outra pessoa consegue assumir a tarefa.</li></ol></div>
...
Próxima verificação:</textarea><div><button class="action-button" type="button" data-copy="#modelo-ata">Copiar ata</button><span class="copy-status" aria-live="polite"></span></div></div>
  ...
  },
  {
    ...
    content: `
      ...
      <h3>Missão da equipe</h3><div class="task-box"><ol><li>Registre o sintoma e a fonte; não escreva a causa se ela não estiver na evidência fornecida pelo professor.</li><li>Use P-40 para escolher alerta imediato, reunião curta somente se necessária, responsáveis e prazos.</li><li>Identifique em P-03/P-30 quais documento, planilha e apresentação dependem do local.</li><li>Atualize primeiro a fonte canônica; gere novas entregas e mantenha as anteriores arquivadas.</li><li>Teste permissões de cada link e confirme destinatários antes da comunicação.</li><li>Registre decisão, tarefas, versões substituídas e confirmação de recebimento.</li><li>O professor introduz uma falha: destinatário homônimo, link sem acesso ou anexo antigo. Detecte-a na conferência, interrompa o envio e corrija sem apagar evidência.</li><li>Encerre acessos temporários e transfira o pacote a outra equipe.</li></ol></div>
      ...
      <div class="bridge-box"><strong>Continuidade</strong><p>Os quatro novos registros estão prontos. O Projeto Integrador reúne P-00 a P-40 para entregar toda a Feira e passar o trabalho adiante.</p></div>`
  }
]);
