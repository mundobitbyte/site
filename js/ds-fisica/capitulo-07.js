(() => {
  ...
  const lessonHtml = `
    ...
    <section>
      ...
      <div class="formula-box"><span class="formula-name">Densidade</span><div class="big-formula">ρ = m / V</div><p><strong>ρ</strong> é a densidade, <strong>m</strong> é a massa e <strong>V</strong> é o volume. No SI, a unidade é kg/m³.</p></div>
      <div class="two-col">
    ...
    <section>
      ...
      <div class="two-col">
        <div class="example-box"><strong class="card-title">Área pequena</strong><p>A mesma força concentrada em uma área menor produz pressão maior. É por isso que uma ponta fina perfura com mais facilidade.</p></div>
        <div class="example-box"><strong class="card-title">Área grande</strong><p>A mesma força distribuída em uma área maior produz pressão menor. Uma base larga espalha a força.</p></div>
      </div>
    ...
    <section>
      ...
      <p>Em um líquido em repouso, a pressão aumenta com a profundidade porque as regiões mais profundas suportam o peso de uma coluna maior de líquido acima delas.</p>
      <svg class="lesson-visual" viewBox="0 0 760 310" role="img" aria-label="Reservatório com três pontos em profundidades diferentes e setas de pressão maiores nos pontos mais profundos">
        <rect x="170" y="45" width="420" height="225" rx="12" fill="#e8f5ff" stroke="#6fa9dc" stroke-width="3"/><line x1="170" y1="75" x2="590" y2="75" stroke="#1967d2" stroke-width="3"/><text x="605" y="80" class="visual-note">superfície</text>
        ...
        <text x="95" y="120" class="visual-note">menor h</text><text x="95" y="180" class="visual-note">h intermediária</text><text x="95" y="240" class="visual-note">maior h</text><text x="225" y="298" class="visual-title">no mesmo líquido, maior profundidade → maior pressão</text>
      </svg>
      <div class="formula-box"><span class="formula-name">Lei de Stevin — variação de pressão</span><div class="big-formula">Δp = ρ · g · h</div><p><strong>h</strong> é a diferença de profundidade. Para obter a pressão absoluta em um ponto, também precisamos considerar a pressão existente na superfície.</p></div>
      <div class="example-box"><strong class="card-title">Exemplo na água</strong><p>Considere ρ = 1.000 kg/m³, g ≈ 10 m/s² e profundidade de 2 m.</p><ol class="reason-steps"><li>Δp = ρ·g·h.</li><li>Δp = 1.000·10·2.</li><li><strong>Δp = 20.000 Pa.</strong></li></ol><p>Esse é o aumento de pressão devido à coluna de água.</p></div>
      <div class="note-box"><strong>A forma do recipiente não entra nessa relação</strong><p>Para pontos no mesmo líquido, em repouso e na mesma profundidade, a pressão é a mesma mesmo que os recipientes tenham formatos diferentes.</p></div>
    </section>

    <section>
      <h3>4. Princípio de Pascal: pressão transmitida em um fluido confinado</h3>
      <p>Em um fluido praticamente incompressível e confinado, uma variação de pressão aplicada em uma região é transmitida às demais regiões do fluido. Essa é a ideia usada em sistemas hidráulicos.</p>
      <svg class="lesson-visual" viewBox="0 0 760 285" role="img" aria-label="Prensa hidráulica com pistão pequeno e pistão grande conectados por fluido">
        <rect x="85" y="85" width="125" height="130" rx="8" fill="#eef5ff" stroke="#1967d2" stroke-width="3"/><rect x="505" y="55" width="170" height="160" rx="8" fill="#eef5ff" stroke="#1967d2" stroke-width="3"/>
        <rect x="105" y="65" width="85" height="20" fill="#70829a"/><rect x="530" y="35" width="120" height="20" fill="#70829a"/><path d="M145 215 V245 H590 V215" fill="none" stroke="#6fa9dc" stroke-width="36" stroke-linecap="round" stroke-linejoin="round"/>
        <line x1="148" y1="28" x2="148" y2="62" stroke="#b42318" stroke-width="5"/><polygon points="148,66 138,49 158,49" fill="#b42318"/><line x1="590" y1="28" x2="590" y2="32" stroke="#1967d2" stroke-width="7"/><polygon points="590,18 578,38 602,38" fill="#1967d2"/>
        <text x="110" y="25" class="visual-title">F₁</text><text x="555" y="25" class="visual-title">F₂ maior</text><text x="110" y="125" class="visual-note">A₁ pequena</text><text x="540" y="115" class="visual-note">A₂ maior</text><text x="260" y="275" class="visual-note">a variação de pressão é transmitida pelo fluido</text>
      </svg>
      <div class="formula-box"><span class="formula-name">Prensa hidráulica ideal</span><div class="big-formula">F₁ / A₁ = F₂ / A₂</div><p>Uma força menor em uma área menor pode corresponder a uma força maior em uma área maior. Isso não cria energia: o pistão de maior área se desloca uma distância menor na proporção adequada.</p></div>
    ...
    <section>
      ...
      <p>Um corpo mergulhado recebe pressão por todos os lados. Como a parte inferior está mais profunda que a superior, as forças de pressão produzem uma resultante vertical para cima: o <strong>empuxo</strong>.</p>
      <svg class="lesson-visual" viewBox="0 0 760 320" role="img" aria-label="Bloco submerso com pressão maior na parte inferior e uma seta de empuxo para cima, além do peso para baixo">
        ...
        <rect x="155" y="40" width="450" height="245" rx="12" fill="#e8f5ff" stroke="#6fa9dc" stroke-width="3"/><line x1="155" y1="75" x2="605" y2="75" stroke="#1967d2" stroke-width="3"/><rect x="315" y="125" width="130" height="95" rx="8" fill="#f5f8fb" stroke="#304257" stroke-width="3"/>
        <line x1="380" y1="135" x2="380" y2="88" stroke="#1967d2" stroke-width="6" marker-end="url(#c7ArrowUp)"/><text x="395" y="103" class="visual-note">empuxo E</text><line x1="380" y1="210" x2="380" y2="265" stroke="#b42318" stroke-width="6" marker-end="url(#c7ArrowDown)"/><text x="395" y="257" class="visual-note">peso P</text>
        <line x1="280" y1="150" x2="315" y2="150" stroke="#6fa9dc" stroke-width="3"/><line x1="280" y1="195" x2="315" y2="195" stroke="#1967d2" stroke-width="6"/><line x1="480" y1="150" x2="445" y2="150" stroke="#6fa9dc" stroke-width="3"/><line x1="480" y1="195" x2="445" y2="195" stroke="#1967d2" stroke-width="6"/><text x="184" y="310" class="visual-title">pressão maior em regiões mais profundas contribui para a resultante para cima</text>
      </svg>
    ...
    <section>
      ...
      <div class="three-col">
        <div class="example-box"><strong class="card-title">ρobj &lt; ρfluido</strong><p>O corpo tende a flutuar parcialmente submerso até que <strong>E = P</strong>.</p></div>
        <div class="example-box"><strong class="card-title">ρobj ≈ ρfluido</strong><p>No modelo ideal, pode permanecer praticamente submerso em equilíbrio.</p></div>
        <div class="example-box"><strong class="card-title">ρobj &gt; ρfluido</strong><p>Mesmo totalmente submerso, o empuxo máximo é insuficiente e o corpo tende a afundar.</p></div>
      </div>
    ...
    <section>
      ...
      <div class="interactive-lab" id="buoyancyLab">
        ...
        <svg class="lesson-visual" viewBox="0 0 760 300" role="img" aria-label="Simulação de um bloco em um líquido">
          <rect id="buoyancyFluid" x="140" y="55" width="480" height="210" rx="12" fill="#e8f5ff" stroke="#6fa9dc" stroke-width="3"/><line x1="140" y1="80" x2="620" y2="80" stroke="#1967d2" stroke-width="3"/><text x="635" y="85" class="visual-note">superfície</text>
          <rect id="buoyancyBlock" x="330" y="53" width="100" height="90" rx="8" fill="#6d4aff" stroke="#49338f" stroke-width="3"/><text x="350" y="295" class="visual-note">a posição do bloco muda conforme a comparação entre as densidades</text>
        </svg>
        <div class="lab-result" aria-live="polite"><span>Peso:</span><strong id="objectWeightValue">35,0 N</strong><span>Empuxo máximo:</span><strong id="maxBuoyancyValue">50,0 N</strong><span>Submerso:</span><strong id="submergedValue">70%</strong><span>Resultado:</span><strong id="buoyancyStatus">Flutua</strong></div>
    ...
    <details class="curriculum-box"><summary>Conexão com o plano de curso</summary><p>Este capítulo trabalha os objetos previstos para a 1ª série em <strong>Hidrostática</strong>: pressão, densidade, Lei de Stevin, Princípio de Pascal e Princípio de Arquimedes/empuxo. A flutuação de navios é usada como situação real para integrar esses conceitos.</p></details>`;
  ...
  function initBuoyancyLab(root) {
    ...
    const fluidRect = $('#buoyancyFluid', root);
    if (!objectDensity || !objectVolume || !fluid || !block || !fluidRect) return;

    const fluids = {
      water: { name: 'Água', rho: 1000, fill: '#e8f5ff' },
      salt: { name: 'Água salgada', rho: 1025, fill: '#e3f4ff' },
      oil: { name: 'Óleo', rho: 800, fill: '#fff6d9' }
    };
    ...
    const draw = () => {
      ...
      fluidRect.setAttribute('fill', selected.fill);

      const status = $('#buoyancyStatus', root);
      const conclusion = $('#buoyancyConclusion', root);
      if (ratio < 0.98) {
        const y = 80 - (1 - ratio) * 90;
        block.setAttribute('y', String(Math.max(8, y)));
        block.setAttribute('fill', '#6d4aff');
        ...
        block.setAttribute('y', '135');
        block.setAttribute('fill', '#087f5b');
        ...
        block.setAttribute('y', '170');
        block.setAttribute('fill', '#b42318');
