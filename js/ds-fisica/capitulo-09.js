(() => {
  ...
  const lessonHtml = `
    ...
    <section>
      ...
      <div class="visual-box"><strong class="card-title">Uma faixa, não uma garantia</strong><svg class="lesson-visual" viewBox="0 0 760 260" role="img" aria-label="Diagrama simplificado de uma estrela, uma faixa de zona habitável e três órbitas"><circle cx="105" cy="130" r="42" fill="#f6c453"/><text x="79" y="136" class="visual-note">estrela</text><rect x="250" y="45" width="250" height="170" rx="80" fill="none" stroke="#7aa56f" stroke-width="24" opacity="0.45"/><text x="305" y="32" class="visual-note">faixa potencialmente habitável</text><circle cx="210" cy="130" r="15" fill="#b42318"/><text x="178" y="168" class="visual-note">muito perto</text><circle cx="370" cy="130" r="15" fill="#1967d2"/><text x="342" y="168" class="visual-note">na faixa</text><circle cx="575" cy="130" r="15" fill="#6f7782"/><text x="548" y="168" class="visual-note">muito longe</text></svg><p class="visual-caption">O desenho mostra apenas a ideia de uma faixa de distância. Atmosfera, pressão, composição e outros fatores continuam necessários.</p></div>
