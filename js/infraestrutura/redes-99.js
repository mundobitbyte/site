...
window.infraestruturaNetworkLessons.push({
  ...
  objective: 'Investigar falhas controladas usando evidência e os artefatos acumulados, aplicar correção segura quando autorizada e entregar documentação reutilizável.',
  content: `
    ...
    <div class="artifact-grid"><div class="artifact-card"><strong>R-00 · entrada</strong><span>dois relatos sem teste recente</span></div><div class="artifact-card"><strong>R-01 · topologia v3</strong><span>AP-01 e IMP-01 presentes; porta 17 sem confirmação</span></div><div class="artifact-card"><strong>R-02 · portas/cabos</strong><span>porta 08 = LAB-06; cabo substituído</span></div><div class="artifact-card"><strong>R-03 · endereçamento</strong><span>proposta /26 aprovada; implantação parcial</span></div><div class="artifact-card"><strong>R-04 · baseline</strong><span>SEC-02 completo; ADM-01 com registro antigo</span></div><div class="artifact-card"><strong>R-06 · serviços</strong><span>IMP-01 TCP 9100; intranet HTTPS</span></div><div class="artifact-card"><strong>R-08 · acessos</strong><span>visitante → internet; visitante ↛ ativos internos</span></div><div class="artifact-card"><strong>R-09 · Wi-Fi</strong><span>pontos A/B/C, mas sem medida após mudança de mobiliário</span></div><div class="artifact-card"><strong>Chamados</strong><span>041 aberto; 042 chegou às 16h26</span></div></div>

    <div class="visual-lab"><div class="visual-lab-header"><span class="visual-kicker">Cenário controlado pelo professor</span><h3>Falhas possíveis — a equipe não sabe de antemão qual foi aplicada</h3><p>O responsável injeta uma ou duas condições em ativos de laboratório. Nenhuma falha exige acesso à rede de produção.</p></div><div class="visual-body"><div class="scenario-grid"><article><strong>F-1 · físico</strong><p>Cabo de referência e cabo defeituoso identificados; um deles está no caminho de LAB-06.</p></article><article><strong>F-2 · configuração</strong><p>Uma estação controlada recebeu DNS ou gateway divergente do baseline.</p></article><article><strong>F-3 · serviço</strong><p>O ativo responde a alcance, mas a porta didática esperada não aceita conexão.</p></article><article><strong>F-4 · segmentação</strong><p>Uma porta de laboratório está associada ao grupo lógico errado no simulador/equipamento didático.</p></article><article><strong>F-5 · Wi-Fi</strong><p>O teste é realizado em local/carga que reproduz cobertura ou capacidade insuficiente.</p></article></div><p class="visual-question"><strong>Não sorteie comandos.</strong> O envelope informa sintoma, origem, destino, horário e impacto; a equipe deve pedir a evidência que falta.</p></div></div>
    ...
    <div class="checkpoint compact-check"><p class="check-progress" data-check-progress></p><ul class="checklist" data-checklist>
      ...
      <li><label><input type="checkbox"> Consultamos R-01 a R-09 e marcamos lacunas ou divergências.</label></li>
...
Função que opera:
Função que falha:
Evidências (ID, horário e local):

3. DOCUMENTAÇÃO REUTILIZADA
R-01/R-02:
R-03/R-04:
R-06/R-08/R-09:
...
Próximo responsável e próximo passo:</textarea>
    ...
    <div class="table-wrap"><table><thead><tr><th>Critério</th><th>Peso</th><th>Domínio demonstrado</th></tr></thead><tbody><tr><td>Raciocínio e poder do teste</td><td>30%</td><td>separa hipóteses com previsão e reconhece limites</td></tr><tr><td>Evidência e correlação</td><td>25%</td><td>origem, destino, serviço, horário e antes/depois comparáveis</td></tr><tr><td>Segurança, autorização e rollback</td><td>20%</td><td>protege produção, dados e acesso; sabe parar</td></tr><tr><td>Validação da função real</td><td>15%</td><td>não confunde link, ping, porta e serviço</td></tr><tr><td>Documentação reutilizável</td><td>10%</td><td>atualiza os artefatos e permite continuidade</td></tr></tbody></table></div>
    ...
    <div class="record-box"><strong>Entrega acumulada</strong><p>O relatório final referencia e atualiza R-00 a R-09. O próximo técnico recebe chamados, mapa, baseline, matriz de serviços e acessos, levantamento Wi-Fi, evidências antes/depois e pendências com responsável — não uma pasta de exercícios isolados.</p></div>
    <div class="essence"><strong>Essência do Módulo 2</strong><p>Redes na prática é tornar comunicação observável: <strong>mapear, prever, testar, interpretar, controlar a mudança, validar a função e registrar o limite</strong>.</p></div>
    <div class="bridge-box"><strong>Limite desta fase</strong><p>O Módulo 2 termina aqui. Não foram iniciados Servidores Linux nem Infraestrutura Moderna. Serviços apareceram apenas como destinos necessários ao diagnóstico de rede.</p></div>
  `
});
