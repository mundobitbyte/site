...
window.infraestruturaModernLessons.push({
  ...
  content: `
    <div class="hero-box story-opening"><span class="eyebrow">Sexta-feira · 13h30 · passagem entre equipes</span><h2>O Portal de Eventos precisa ser preparado para o ensaio da feira — e o ambiente recebido não coincide totalmente com a documentação.</h2><p>A equipe recebe APP-LAB-01 ou VPS-LAB-01, os artefatos A-00 a A-10 e uma solicitação: validar uma atualização ou reproduzir o serviço em outra VM. O professor aplicou uma condição desconhecida. <strong>O resultado válido pode ser implantar, reverter ou parar com evidência.</strong></p></div>

    <h3>Envelope recebido</h3>
    <div class="artifact-grid"><div class="artifact-card"><strong>A-00 · necessidade</strong><span>público, impacto, dado e limite</span></div><div class="artifact-card"><strong>A-01 · VM</strong><span>host, recursos, rede e snapshot</span></div><div class="artifact-card"><strong>A-02 · capacidade</strong><span>uma/duas VMs e custo operacional</span></div><div class="artifact-card"><strong>A-03 · runtime</strong><span>Docker, versões e estados</span></div><div class="artifact-card"><strong>A-04 · persistência</strong><span>camada, bind e evidência</span></div><div class="artifact-card"><strong>A-05 · Compose</strong><span>serviços, redes, volumes e digests</span></div><div class="artifact-card"><strong>A-06 · atualização</strong><span>backup, teste, parada e rollback</span></div><div class="artifact-card"><strong>A-07 · nuvem</strong><span>responsabilidade e decisão condicional</span></div><div class="artifact-card"><strong>A-08 · implantação</strong><span>host remoto, túnel e passagem</span></div><div class="artifact-card"><strong>A-09 · exposição</strong><span>DNS, porta, TLS e escopo</span></div><div class="artifact-card"><strong>A-10 · arquitetura</strong><span>decisão, limites e gatilhos</span></div></div>

    <div class="visual-lab"><div class="visual-lab-header"><span class="visual-kicker">Falha controlada · escolha do professor</span><h3>A equipe recebe sintoma, não a etiqueta da falha</h3></div><div class="visual-body"><div class="scenario-grid"><article><strong>F-M1 · capacidade</strong><p>disco/ memória não coincide com o baseline.</p></article><article><strong>F-M2 · Compose</strong><p>porta, rede ou mount diverge do A-05.</p></article><article><strong>F-M3 · persistência</strong><p>um volume esperado não está associado.</p></article><article><strong>F-M4 · imagem</strong><p>tag/digest recebido difere do aprovado.</p></article><article><strong>F-M5 · aplicação</strong><p>web iniciou antes de o banco ficar pronto.</p></article><article><strong>F-M6 · exposição</strong><p>porta escuta em endereço mais amplo que o previsto.</p></article><article><strong>F-M7 · segredo</strong><p>arquivo ausente, permissão inadequada ou valor incompatível.</p></article><article><strong>F-M8 · recuperação</strong><p>a cópia existe, mas a restauração de amostra falha.</p></article></div><p class="visual-question">Qual evidência separa sua hipótese de uma alternativa sem modificar o ambiente?</p></div></div>
    ...
    <div class="checkpoint compact-check"><p class="check-progress" data-check-progress></p><ul class="checklist" data-checklist>
      ...
      <li><label><input type="checkbox"> Comparamos inventário real com A-01/A-03/A-05 antes de executar Compose.</label></li>
    ...
    <div class="table-wrap"><table><thead><tr><th>Fase</th><th>Produção concreta</th><th>Critério de avanço</th></tr></thead><tbody><tr><td>Receber</td><td>inventário e divergências</td><td>alvo e limites inequívocos</td></tr><tr><td>Entender</td><td>impacto, H1/H2 e previsão</td><td>teste distingue hipóteses</td></tr><tr><td>Proteger</td><td>backup + restauração de amostra</td><td>retorno praticável</td></tr><tr><td>Intervir</td><td>mudança única registrada</td><td>resultado dentro do esperado</td></tr><tr><td>Validar</td><td>antes/depois comparável</td><td>função e persistência verificadas</td></tr><tr><td>Entregar</td><td>A-registros atualizados</td><td>outra equipe consegue continuar</td></tr></tbody></table></div>

    <h3>Pacote de evidências</h3>
    <div class="artifact-grid"><div class="artifact-card"><strong>E-M1 · estado inicial</strong><span>host/VM, versão, recurso, rede e horário</span></div><div class="artifact-card"><strong>E-M2 · manifesto</strong><span>configuração efetiva sem segredos</span></div><div class="artifact-card"><strong>E-M3 · hipótese/teste</strong><span>previsão, saída relevante e limite</span></div><div class="artifact-card"><strong>E-M4 · recuperação</strong><span>amostra restaurada separadamente</span></div><div class="artifact-card"><strong>E-M5 · intervenção</strong><span>autorização, mudança e rollback</span></div><div class="artifact-card"><strong>E-M6 · validação</strong><span>processo, função, dado e acesso</span></div><div class="artifact-card"><strong>E-M7 · passagem</strong><span>estado final, risco e responsável</span></div></div>

    <textarea id="modern-final-report" class="report-template" aria-label="Modelo de relatório da oficina moderna" readonly>OFICINA DE INFRAESTRUTURA MODERNA — MÓDULO 4
Equipe / papéis / data:
...
Pendências / próximo responsável / prazo:</textarea>
    ...
    <div class="bridge-box"><strong>Módulo 4 concluído</strong><p>A oficina fecha Infraestrutura Moderna. O Laboratório Integrador da área reutilizará os artefatos dos quatro módulos e introduzirá uma missão única de passagem entre equipes.</p></div>
  `
});
