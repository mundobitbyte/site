...
window.infraestruturaModernLessons.push({
  ...
  content: `
    <div class="hero-box story-opening"><span class="eyebrow">Sexta-feira · 13h30 · passagem entre equipes</span><h2>O Portal de Eventos precisa ser preparado para o ensaio da feira — e o ambiente recebido não coincide totalmente com a documentação.</h2><p>A equipe recebe APP-LAB-01 ou VPS-LAB-01, os o Registro da Evolução atualizado e uma solicitação: validar uma atualização ou reproduzir o serviço em outra VM. O ambiente contém uma condição controlada cuja causa não foi informada. <strong>O resultado válido pode ser implantar, reverter ou parar com evidência.</strong></p></div>

    <h3>Envelope recebido</h3>
    <div class="artifact-grid"><div class="artifact-card"><strong>necessidade registrada · necessidade</strong><span>público, impacto, dado e limite</span></div><div class="artifact-card"><strong>projeto e medição da VM · VM</strong><span>host, recursos, rede e snapshot</span></div><div class="artifact-card"><strong>comparação de capacidade e custo · capacidade</strong><span>uma/duas VMs e custo operacional</span></div><div class="artifact-card"><strong>inventário do runtime · runtime</strong><span>Docker, versões e estados</span></div><div class="artifact-card"><strong>evidência de persistência · persistência</strong><span>camada, bind e evidência</span></div><div class="artifact-card"><strong>manifesto Compose · Compose</strong><span>serviços, redes, volumes e digests</span></div><div class="artifact-card"><strong>plano de atualização · atualização</strong><span>backup, teste, parada e rollback</span></div><div class="artifact-card"><strong>decisão de hospedagem · nuvem</strong><span>responsabilidade e decisão condicional</span></div><div class="artifact-card"><strong>implantação remota · implantação</strong><span>host remoto, túnel e passagem</span></div><div class="artifact-card"><strong>mapa de exposição · exposição</strong><span>DNS, porta, TLS e escopo</span></div><div class="artifact-card"><strong>decisão arquitetural · arquitetura</strong><span>decisão, limites e gatilhos</span></div></div>

    <div class="visual-lab"><div class="visual-lab-header"><span class="visual-kicker">Ambiente controlado · causa desconhecida</span><h3>A equipe recebe o sintoma, não a causa pronta</h3></div><div class="visual-body"><div class="scenario-grid"><article><strong>capacidade</strong><p>disco/ memória não coincide com o baseline.</p></article><article><strong>Compose</strong><p>porta, rede ou mount diverge do manifesto Compose aprovado.</p></article><article><strong>persistência</strong><p>um volume esperado não está associado.</p></article><article><strong>imagem</strong><p>tag/digest recebido difere do aprovado.</p></article><article><strong>aplicação</strong><p>web iniciou antes de o banco ficar pronto.</p></article><article><strong>exposição</strong><p>porta escuta em endereço mais amplo que o previsto.</p></article><article><strong>segredo</strong><p>arquivo ausente, permissão inadequada ou valor incompatível.</p></article><article><strong>recuperação</strong><p>a cópia existe, mas a restauração de amostra falha.</p></article></div><p class="visual-question">Qual evidência separa sua hipótese de uma alternativa sem modificar o ambiente?</p></div></div>
