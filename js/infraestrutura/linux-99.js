...
window.infraestruturaLinuxLessons.push({
  ...
  content: `
    ...
    <div class="visual-lab"><div class="visual-lab-header"><span class="visual-kicker">Falha controlada · não revelada à equipe</span><h3>O professor escolhe uma ou duas condições</h3><p>Os rótulos abaixo ficam com o professor. O aluno recebe apenas sintoma, impacto e os registros.</p></div><div class="visual-body"><div class="scenario-grid"><article><strong>F-1 · montagem</strong><p>O volume de dados não está no ponto esperado após boot.</p></article><article><strong>F-2 · permissão</strong><p>Grupo, proprietário ou modo diverge de matriz de identidades e permissões/mapa de armazenamento.</p></article><article><strong>F-3 · serviço</strong><p>Nginx, Samba ou SSH está inativo/falhou.</p></article><article><strong>F-4 · configuração</strong><p>Netplan, Nginx, Samba ou SSH contém uma divergência validável.</p></article><article><strong>F-5 · firewall</strong><p>Uma origem necessária ou indevida produz resultado diferente de matriz de serviços e firewall.</p></article><article><strong>F-6 · capacidade</strong><p>Filesystem cheio ou crescimento não explicado afeta uma função.</p></article><article><strong>F-7 · recuperação</strong><p>O arquivo de backup existe, mas a amostra esperada não restaura.</p></article></div><p class="visual-question"><strong>Não sorteie comandos:</strong> peça a evidência que melhor separa suas hipóteses e registre por que ela vem agora.</p></div></div>
    ...
    <div class="note-box compact"><strong>Uma captura só entra se muda a decisão.</strong><p>Explique a evidência no texto: “H2 ganhou força porque o teste observacional mostrou...”. Saídas preparadas pelo professor devem permanecer rotuladas como representativas.</p></div>
