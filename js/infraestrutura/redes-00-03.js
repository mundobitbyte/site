...
window.infraestruturaNetworkLessons.push({
  ...
  content: `
    <div class="hero-box story-opening"><span class="eyebrow">OS 011 · Continuação do Chamado 032</span><h2>O armário tem cabos, mas não tem memória.</h2><p>A auxiliar Joana encontra um roteador identificado como <strong>RTmapa/inventário</strong>, um switch <strong>SW-01</strong>, um patch panel sem legenda e o ponto de acesso <strong>AP-01</strong> no corredor. O inventário recebido do suporte localiza SEC-02, LAB-06, SALA-04 e ADM-01, mas não registra portas de rede. Se alguém desconectar “um cabo qualquer”, não há como prever o impacto.</p></div>
    ...
    <div class="visual-lab"><div class="visual-lab-header"><span class="visual-kicker">Representação didática</span><h3>Mapa parcial encontrado na pasta de suporte</h3><p>Observe as relações. Linha contínua indica cabo; linha pontilhada indica Wi-Fi. O desenho não é captura de um software.</p></div><div class="visual-body">
      ...
      <div class="network-map" role="img" aria-label="Internet ligada ao roteador RTmapa/inventário, ligado ao switch SW-01. Switch ligado à secretaria SEC-02, laboratório LAB-06 e ponto de acesso AP-01. AP ligado por Wi-Fi à sala SALA-04. Impressora IMP-01 sem ligação documentada.">
        <div class="net-node cloud">Internet<br><small>provedor</small></div><div class="net-link"></div><div class="net-node router">RTmapa/inventário<br><small>gateway</small></div><div class="net-link"></div><div class="net-node switch">SW-01<br><small>porta ?</small></div>
    ...
    <div class="table-wrap"><table><thead><tr><th>ID</th><th>Função / responsável</th><th>Local</th><th>Conexão conhecida</th><th>Lacuna</th></tr></thead><tbody><tr><td>RTmapa/inventário</td><td>Gateway / TI</td><td>Armário</td><td>Provedor ↔ SW-01</td><td>porta WAN e plano atual</td></tr><tr><td>SW-01</td><td>Distribuição / TI</td><td>Armário</td><td>24 portas</td><td>mapa porta-setor</td></tr><tr><td>AP-01</td><td>Wi-Fi / TI</td><td>Corredor</td><td>ligado ao SW-01</td><td>porta, cobertura e SSIDs</td></tr><tr><td>IMP-01</td><td>Impressão / secretaria</td><td>Secretaria</td><td>desconhecida</td><td>IP, meio e serviço</td></tr></tbody></table></div>
...
window.infraestruturaNetworkLessons.push({
  ...
  content: `
    <div class="hero-box story-opening"><span class="eyebrow">Chamado 033 · LAB-06</span><h2>A falha tem movimento, horário e um caminho físico.</h2><p>Caio demonstra que LAB-06 perde conectividade quando a mesa encosta no cabo azul. Os demais computadores continuam ativos. O mapa mapa/inventário aponta o setor, mas o patch panel e o SW-01 ainda não relacionam a tomada à porta. Antes de discutir endereços, a equipe precisa reconhecer objetos e comparar estados de link.</p></div>
...
window.infraestruturaNetworkLessons.push({
  ...
  content: `
    <div class="hero-box story-opening"><span class="eyebrow">OS 012 · decisão de capacidade e organização</span><h2>Uma rede plana atende hoje, mas não expressa a nova escola.</h2><p>O mapa/inventário registra 18 dispositivos de funcionários, 22 do laboratório e até 25 visitantes em eventos. A faixa disponível é <strong>192.168.10.0/24</strong>. A direção quer crescimento sem renumerar tudo no próximo mês; a equipe ainda não implementará VLANs, apenas preparará um plano que possa ser usado depois.</p></div>
    ...
    <div class="task-box"><strong>Missão 03 · planejar o endereçamento</strong><p>Registre grupo, prefixo, capacidade necessária, rede, faixa utilizável, broadcast, gateway proposto, intervalo DHCP, reservas e justificativa. Faça uma equipe revisar fronteiras e outra comparar com o mapa/inventário. <strong>Não aplique o plano na rede em produção nesta missão.</strong></p></div>
