# Piloto pedagógico — Informática e Produtividade

> **Arquivo de avaliação.** Não substitui os arquivos canônicos do módulo e não altera a área publicada.
>
> Objetivo: testar uma mudança de **condução didática**, preservando o conteúdo técnico, o cenário da Escola Horizonte, os registros cumulativos, a segurança e a progressão aprovada.

## Princípio do piloto

A aula passa a seguir, de forma visível para o iniciante:
...
# Aula 00 — A pasta que ninguém consegue entregar

## Segunda-feira, 8h15 — Escola Horizonte
...
Nesta aula, você vai aprender a receber uma pasta de trabalho sem destruir informações importantes.
...
Abra um editor de texto simples e crie o arquivo:
...
**“acho que este é o arquivo certo”**
...
Se você chegou até aqui, já conseguiu fazer algo essencial:

**recebeu um conjunto confuso de arquivos sem apagar pistas e sem transformar suposição em certeza.**

Agora sabemos o que existe.

Mas ainda falta responder outra pergunta:

**o que exatamente a Escola Horizonte espera que seja entregue?**

É isso que vamos resolver na próxima aula.

---

# Aula 01 — O pedido vem antes da ferramenta
...
A resposta inicial é:

**“Organizem tudo para a Feira.”**
...
Nesta aula, você vai aprender a transformar um pedido vago em algo que pode ser conferido.
...
Dentro dele aparece a frase:

**“acho que a abertura mudou para 08:30”.**

Podemos publicar 8h30 como horário oficial?
...
**P-00 — Pedido e critérios.**

Aqui, “critério” significa simplesmente:

**como vamos saber que a entrega está correta e pronta.**

Crie, em um editor de texto simples:

`P-00_pedido-e-criterios.txt`

Salve-o ao lado do `P-01_inventario.txt`.

## Faça comigo — preencha o pedido
...
Responsáveis:
Marina — inscrições
Paulo — aprovação do horário
Lia — organização dos arquivos
...
Quando uma informação estiver faltando, escreva **pendente** em vez de inventar uma resposta.

## Confira se o registro realmente ajuda
...
- explicações de “por que” aparecem antes do próximo procedimento;
- o aluno recebe menos conceitos simultaneamente;
- a mesma competência profissional é mantida, mas com mais mediação didática.