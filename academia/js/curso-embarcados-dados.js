(function () {
  ...
  const aulas = [
    ...
    aula('emb-07-05', 'emb-07', 'MQTT: publicar sem conhecer cada assinante', 'Quando publicação/assinatura é melhor que solicitação/resposta?', [], {
      ...
      fazer: 'Modele uma experiência: ESP32 publica em ambiente/luz; um painel assina o tópico. Identifique publisher, subscriber, broker, topic e mensagem. Use apenas broker de teste sem dados pessoais ou credenciais reutilizadas.',
      observar: 'HTTP costuma usar solicitação/resposta; MQTT usa publicação/assinatura mediada por broker.',
